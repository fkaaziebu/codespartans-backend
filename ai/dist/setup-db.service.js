...
const course_entity_2 = require("./modules/inventory/entities/course.entity");
const question_entity_2 = require("./modules/review/entities/question.entity");
const version_entity_2 = require("./modules/review/entities/version.entity");
let SetupDbService = SetupDbService_1 = class SetupDbService {
    constructor(instructorRepository, organizationRepository, adminRepository, cartRepository, courseRepository, versionRepository, questionRepository, categoryRepository, testSuiteRepository, imageRepository, planRepository, configService) {
    ...
    async setupDatabase() {
        try {
            ...
            const new_wassce_courses = await Promise.all(wassce_courses.map(async (course_name, idx) => {
                const wassce_course = new course_entity_1.Course();
                wassce_course.avatar_url =
                    subjectImageUrls[course_name] || subjectImageUrls['Mathematics'];
                wassce_course.currency = course_entity_2.CurrencyType.USD;
                wassce_course.description = 'This is a test course';
                wassce_course.domains = [course_entity_2.DomainType.ENGLISH];
                wassce_course.level = course_entity_2.LevelType.BEGINNER;
            ...
            const new_wassce_course_versions = await Promise.all(new_wassce_courses.map(async (course) => {
                const version = new version_entity_1.Version();
                version.status = version_entity_2.VersionStatusType.APPROVED;
            ...
            const courseQuestionsMap = {
                Mathematics: [
                    {
                        suiteTitle: 'WASSCE Mathematics — Number, Numeration & Algebra',
                        suiteDescription: '8 questions covering Number & Numeration (fractions, decimals, HCF) and Algebra (equations, simplification, expansion).',
                        ...
                        questions: [
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_NUMBER_AND_NUMERATION],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 60000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_NUMBER_AND_NUMERATION],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 60000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                            ...
                            {
                                question_number: 4,
                                description: 'Express 0.625 as a fraction in its simplest form: ___',
                            ...
                            {
                                question_number: 5,
                                description: 'If x + 5 = 12, find x. (Enter the numerical value only)',
                                hints: ['Subtract 5 from both sides.'],
                                solution_steps: ['x = 12 − 5 = 7'],
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_ALGEBRA],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                            ...
                            },
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_ALGEBRA],
                                difficulty: question_entity_2.QuestionDifficultyType.MEDIUM,
                    ...
                    {
                        suiteTitle: 'WASSCE Mathematics — Geometry, Statistics & Applied Maths',
                        suiteDescription: '22 questions covering Mensuration, Geometry, Statistics, Probability, Sets, Ratio, Percentages, Trigonometry, Indices and Word Problems.',
                        suiteKeywords: ['WASSCE', 'Mathematics', 'Geometry', 'Statistics'],
                        questions: [
                            {
                                question_number: 1,
                                description: 'The area of a rectangle of length 8 cm and width 5 cm is ___ cm².',
                                hints: ['Area = length × width.'],
                                solution_steps: ['Area = 8 × 5 = 40 cm²'],
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_MENSURATION],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 45000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_GEOMETRY],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                            ...
                            },
                            {
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_STATISTICS_AND_PROBABILITY],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 45000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                options: ['2', '3', '4', '5'],
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_SETS],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 30000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_TRIGONOMETRY],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 30000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                    ...
                    },
                    {
                        ...
                        suiteDescription: '5 introductory questions covering basic algebra, number theory, and simple geometry for SHS 1 students.',
                        suiteKeywords: ['SHS 1', 'Mathematics', 'Foundations', 'Algebra'],
                        suiteType: test_suite_entity_1.SuiteType.CLASS,
                        questions: [
                            {
                                question_number: 1,
                                ...
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 30000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_1,
                                exam_year: 2023,
                                correct_answer: '5x',
                            },
                            {
                    ...
                    },
                    {
                        ...
                        suiteDescription: '5 questions focused on trigonometric ratios, identities, and applications.',
                        suiteKeywords: ['Mathematics', 'Trigonometry', 'SOH-CAH-TOA'],
                        suiteType: test_suite_entity_1.SuiteType.TOPIC,
                        questions: [
                            {
                                question_number: 1,
                                description: 'In a right-angled triangle, sin θ = opposite/hypotenuse. If the opposite side is 3 and hypotenuse is 5, what is sin θ?',
                                ...
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 45000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_2,
                                exam_year: 2023,
                                correct_answer: '0.6',
                            },
                            {
                            ...
                            {
                                question_number: 4,
                                description: 'A ladder leans against a wall. The ladder is 10 m long and makes an angle of 60° with the ground. How high up the wall does it reach? (in metres, round to 1 decimal place)',
                ...
                'English Language': [
                    {
                        ...
                        suiteDescription: '5 questions spanning Grammar, Vocabulary and Figures of Speech.',
                        ...
                        questions: [
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_GRAMMAR_AND_USAGE],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 60000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_VOCABULARY],
                                difficulty: question_entity_2.QuestionDifficultyType.MEDIUM,
                                estimated_time_in_ms: 60000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            {
                                question_number: 5,
                                description: 'A synonym of "laconic" (using very few words) is ___.',
                                ...
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_VOCABULARY],
                                difficulty: question_entity_2.QuestionDifficultyType.HARD,
                                estimated_time_in_ms: 60000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                    ...
                    {
                        suiteTitle: 'WASSCE English Language — Usage, Phonetics & Oral English',
                        suiteDescription: '5 questions spanning Sentence Construction, Phonetics, Antonyms and Oral English.',
                        suiteKeywords: ['WASSCE', 'English', 'Oral', 'Phonetics'],
                        questions: [
                            {
                                question_number: 1,
                                description: 'Choose the word that best completes the sentence: "The committee ___ yet to reach a decision."',
                                hints: [
                            ...
                            {
                                question_number: 2,
                                description: 'In phonetics, which sound does the underlined letter represent in the word "church"? (the "ch")',
                                ...
                                options: ['/s/', '/ʃ/', '/tʃ/', '/k/'],
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_ORAL_ENGLISH],
                                difficulty: question_entity_2.QuestionDifficultyType.MEDIUM,
                                estimated_time_in_ms: 60000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            {
                                question_number: 5,
                                description: 'When "record" is used as a verb, the stress falls on the ___ syllable.',
                                hints: [
                    ...
                    },
                    {
                        ...
                        suiteDescription: '4 open-ended questions requiring elaborated written responses, marked by AI.',
                        suiteKeywords: [
                            'WASSCE',
                            'English',
                            'Essay',
                        ...
                        questions: [
                            {
                                question_number: 1,
                                description: 'Explain what is meant by "subject-verb agreement" and give one example of a sentence that violates it, then correct the sentence.',
                                hints: [
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.SHORT_ANSWER,
                                tags: [question_entity_2.QuestionTagType.TAG_GRAMMAR_AND_USAGE],
                                difficulty: question_entity_2.QuestionDifficultyType.MEDIUM,
                                estimated_time_in_ms: 180000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                                correct_answer: 'Subject-verb agreement means the subject and verb must match in number. Example of violation: "The boys was late." Corrected: "The boys were late."',
                                marks: 3,
                            },
                            {
                                question_number: 2,
                                description: 'In your own words, explain the difference between a simile and a metaphor. Give one original example of each.',
                                hints: [
                            ...
                            },
                            {
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.SHORT_ANSWER,
                                tags: [question_entity_2.QuestionTagType.TAG_READING_COMPREHENSION],
                                difficulty: question_entity_2.QuestionDifficultyType.MEDIUM,
                                estimated_time_in_ms: 240000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                                correct_answer: 'The passage argues that true education develops the whole person — including critical thinking and communication skills — rather than focusing solely on knowledge acquisition or exam performance.',
                                marks: 5,
                            },
                            {
                                question_number: 4,
                                description: 'Write a short paragraph (4–6 sentences) arguing for or against the following statement: "Social media has done more harm than good to young people."',
                                hints: [
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.SHORT_ANSWER,
                                tags: [question_entity_2.QuestionTagType.TAG_ESSAY_WRITING],
                                difficulty: question_entity_2.QuestionDifficultyType.HARD,
                                estimated_time_in_ms: 300000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                                correct_answer: 'A well-structured paragraph that clearly states a position (for or against), supports it with at least two coherent reasons, uses appropriate connectives, and ends with a strong conclusion.',
                                marks: 6,
                            },
                        ],
                    },
                ...
                Physics: [
                    {
                        ...
                        suiteDescription: '5 questions spanning Mechanics, Waves and Electricity.',
                        suiteKeywords: ['WASSCE', 'Physics', 'Mechanics'],
                        questions: [
                            {
                                question_number: 1,
                                description: 'A body of mass 5 kg acted on by a net force of 20 N has an acceleration of ___ m/s².',
                                hints: ["Use Newton's second law: F = ma."],
                                solution_steps: ['a = F/m = 20/5 = 4 m/s²'],
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_MECHANICS],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 60000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_WAVES_AND_OPTICS],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 45000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_ELECTRICITY_AND_MAGNETISM],
                                difficulty: question_entity_2.QuestionDifficultyType.MEDIUM,
                                estimated_time_in_ms: 90000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_HEAT_AND_THERMODYNAMICS],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 45000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                    ...
                    },
                    {
                        ...
                        suiteDescription: '5 questions spanning Heat & Thermodynamics, Atomic Physics, Measurement and Wave Speed.',
                        ...
                        questions: [
                            ...
                            {
                                question_number: 2,
                                description: "Using Ohm's law, if V = 12 V and R = 4 Ω, the current I = ___ A.",
                            ...
                            {
                                question_number: 3,
                                description: 'Which particle determines the atomic number of an element?',
                                hints: [
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_ATOMIC_AND_NUCLEAR_PHYSICS],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 45000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_MEASUREMENT],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 30000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            {
                                question_number: 5,
                                description: 'A wave has a frequency of 500 Hz and a wavelength of 0.4 m. Find its speed.',
                ...
                Chemistry: [
                    {
                        suiteTitle: 'WASSCE Chemistry — Atomic Structure, Bonding & Stoichiometry',
                        suiteDescription: '5 questions spanning Atomic Structure, Periodic Table, Chemical Bonding, Acids/Bases and Stoichiometry.',
                        ...
                        questions: [
                            {
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_ATOMIC_STRUCTURE],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 30000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_PERIODIC_TABLE],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 45000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            {
                                question_number: 3,
                                description: 'The type of bond formed when atoms share electrons is called ___.',
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_CHEMICAL_BONDING],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 45000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_ACIDS_BASES_AND_SALTS],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 30000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                options: ['1', '2', '3', '4'],
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_STOICHIOMETRY],
                                difficulty: question_entity_2.QuestionDifficultyType.MEDIUM,
                                estimated_time_in_ms: 90000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                    ...
                    {
                        suiteTitle: 'WASSCE Chemistry — Organic Chemistry, Electrochemistry & Air',
                        suiteDescription: '5 questions spanning Organic Chemistry, Electrochemistry, Air & Water and Mass Number.',
                        suiteKeywords: [
                            'WASSCE',
                            'Chemistry',
                            'Organic',
                        ...
                        questions: [
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_ORGANIC_CHEMISTRY],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 45000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            {
                                question_number: 2,
                                description: 'During electrolysis, oxidation occurs at the ___.',
                                hints: [
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_ELECTROCHEMISTRY],
                                difficulty: question_entity_2.QuestionDifficultyType.MEDIUM,
                                estimated_time_in_ms: 60000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_AIR_AND_WATER],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 45000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            {
                                question_number: 4,
                                description: 'An atom has 11 protons and 12 neutrons. What is its mass number?',
                ...
                Biology: [
                    {
                        ...
                        suiteDescription: '5 questions spanning Cell Biology, Genetics and Ecology.',
                        ...
                        questions: [
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_CELL_BIOLOGY],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 60000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_GENETICS_AND_EVOLUTION],
                                difficulty: question_entity_2.QuestionDifficultyType.MEDIUM,
                                estimated_time_in_ms: 60000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_SELECT,
                                tags: [question_entity_2.QuestionTagType.TAG_HUMAN_PHYSIOLOGY],
                                difficulty: question_entity_2.QuestionDifficultyType.MEDIUM,
                                estimated_time_in_ms: 60000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                                correct_answer: 'They contain haemoglobin that binds oxygen,They are biconcave to maximise surface area for gas exchange,They are produced in the red bone marrow',
                            },
                            {
                                question_number: 5,
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_PLANT_BIOLOGY],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 60000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                    ...
                    {
                        suiteTitle: 'WASSCE Biology — Human Physiology, Disease & Classification',
                        suiteDescription: '5 questions spanning Ecology, Microorganisms & Disease, Classification, Human Physiology and Genetics.',
                        suiteKeywords: ['WASSCE', 'Biology', 'Physiology', 'Disease'],
                        questions: [
                            {
                                question_number: 1,
                                description: 'Organisms that produce their own food through photosynthesis are called ___.',
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_ECOLOGY],
                                difficulty: question_entity_2.QuestionDifficultyType.MEDIUM,
                                estimated_time_in_ms: 60000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_MICROORGANISMS_AND_DISEASE],
                                difficulty: question_entity_2.QuestionDifficultyType.MEDIUM,
                                estimated_time_in_ms: 60000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            {
                                question_number: 3,
                                description: 'Select **all** statements that correctly describe the taxonomic hierarchy of biological classification.',
                                hints: [
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_SELECT,
                                tags: [question_entity_2.QuestionTagType.TAG_CLASSIFICATION],
                                difficulty: question_entity_2.QuestionDifficultyType.MEDIUM,
                                estimated_time_in_ms: 90000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                                correct_answer: 'Kingdom is the broadest classification level,Species is the most specific classification level,Genus and Species form binomial nomenclature',
                            },
                            {
                                question_number: 4,
                            ...
                            {
                                question_number: 5,
                                description: 'Select **all** correct statements about a monohybrid cross TT × tt.',
                                hints: [
                                ...
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                                correct_answer: 'All F₁ offspring have genotype Tt,All F₁ offspring express the dominant phenotype',
                            },
                        ],
                    },
                ],
                Economics: [
                    {
                        ...
                        suiteDescription: '5 questions spanning Demand & Supply, Production Costs and National Income.',
                        suiteKeywords: ['WASSCE', 'Economics', 'Demand', 'Supply'],
                        questions: [
                            {
                                question_number: 1,
                                description: 'A rise in the price of a good leads to a decrease in the quantity demanded. This illustrates the ___.',
                                hints: [
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_DEMAND_AND_SUPPLY],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 60000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            {
                                question_number: 3,
                                description: 'A cost that does not change regardless of the level of output is called ___.',
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_PRODUCTION_AND_COSTS],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 60000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_NATIONAL_INCOME],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 30000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_MONEY_AND_BANKING],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 45000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                    ...
                    {
                        suiteTitle: 'WASSCE Economics — International Trade, Public Finance & Banking',
                        suiteDescription: '5 questions spanning International Trade, Public Finance, Economies of Scale, National Income and Money & Banking.',
                        suiteKeywords: ['WASSCE', 'Economics', 'Trade', 'Finance'],
                        questions: [
                            {
                                question_number: 1,
                                description: 'The policy of protecting domestic industries from foreign competition through tariffs and quotas is called ___.',
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_INTERNATIONAL_TRADE],
                                difficulty: question_entity_2.QuestionDifficultyType.MEDIUM,
                                estimated_time_in_ms: 60000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            {
                                question_number: 2,
                                description: "A tax system where the tax rate increases as the taxpayer's income increases is called ___.",
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_PUBLIC_FINANCE],
                                difficulty: question_entity_2.QuestionDifficultyType.MEDIUM,
                                estimated_time_in_ms: 60000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            {
                                question_number: 4,
                                description: 'Net National Product (NNP) is equal to GNP minus ___.',
                ...
                Geography: [
                    {
                        ...
                        suiteDescription: '5 questions spanning Physical Geography, Human Geography and Regional Geography.',
                        ...
                        questions: [
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_PHYSICAL_GEOGRAPHY],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 45000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            {
                                question_number: 2,
                                description: 'The process by which rocks are broken down by weather conditions is called ___.',
                            ...
                            {
                                question_number: 3,
                                description: 'The movement of people from rural areas to urban areas is known as ___.',
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_HUMAN_GEOGRAPHY],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 45000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_REGIONAL_GEOGRAPHY],
                                difficulty: question_entity_2.QuestionDifficultyType.MEDIUM,
                                estimated_time_in_ms: 60000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_ECONOMIC_GEOGRAPHY],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 45000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                    ...
                    {
                        suiteTitle: 'WASSCE Geography — Map Reading, Rainfall & Economic Geography',
                        suiteDescription: '5 questions covering Map Reading, Convectional Rainfall, Oceans, Regional Geography and Economic Geography.',
                        ...
                        questions: [
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_MAP_READING],
                                difficulty: question_entity_2.QuestionDifficultyType.MEDIUM,
                                estimated_time_in_ms: 90000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            {
                                question_number: 2,
                                description: 'The type of rainfall commonly experienced in West Africa during summer is ___ rainfall.',
                                hints: [
                ...
                Literature: [
                    {
                        suiteTitle: 'WASSCE Literature in English — Prose, Poetry & Drama Basics',
                        suiteDescription: '5 questions spanning Prose (Fiction, Narration), Poetry (Alliteration, Sonnet) and Drama (Tragedy).',
                        ...
                        questions: [
                            {
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_PROSE],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 30000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            {
                                question_number: 2,
                                description: 'The repetition of consonant sounds at the beginning of closely linked words is called ___.',
                                hints: [
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_POETRY],
                                difficulty: question_entity_2.QuestionDifficultyType.MEDIUM,
                                estimated_time_in_ms: 60000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_DRAMA],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 45000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                    ...
                    {
                        suiteTitle: 'WASSCE Literature in English — Drama Techniques & Advanced Devices',
                        suiteDescription: '5 questions covering dramatic plot, simile, protagonist, soliloquy and assonance.',
                        ...
                        questions: [
                            ...
                            {
                                question_number: 2,
                                description: 'A comparison of two unlike things using "like" or "as" is called a ___.',
                            ...
                            {
                                question_number: 5,
                                description: 'The repetition of vowel sounds in closely placed words, e.g. "the rain in Spain", is called ___.',
                                hints: [
                ...
                Government: [
                    {
                        suiteTitle: 'WASSCE Government — Constitution, Democratic Institutions & Independence',
                        suiteDescription: "5 questions spanning the Constitution, Democratic Institutions and Ghana's Political History.",
                        ...
                        questions: [
                            {
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_CONSTITUTION_AND_LAW],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 30000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_DEMOCRATIC_INSTITUTIONS],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 30000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            {
                                question_number: 3,
                                description: 'Select **all** that are arms of government in Ghana.',
                                hints: [
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_SELECT,
                                tags: [question_entity_2.QuestionTagType.TAG_GOVERNMENT_AND_CITIZENSHIP],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 45000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_GHANA_POLITICAL_HISTORY],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 30000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            {
                                question_number: 6,
                                description: 'The body responsible for conducting elections in Ghana is the ___.',
                    ...
                    {
                        suiteTitle: 'WASSCE Government — Elections, Federal Systems & Ghana Regions',
                        suiteDescription: "5 questions spanning Electoral Commission, Federalism, Voting Age and Ghana's administrative regions.",
                        suiteKeywords: ['WASSCE', 'Government', 'Elections', 'Federalism'],
                        questions: [
                            {
                                question_number: 1,
                                description: 'A system of government in which power is shared between a central government and regional units is called ___.',
                ...
                History: [
                    {
                        suiteTitle: 'WASSCE History — Pre-colonial Africa & Independence Movements',
                        suiteDescription: '5 questions spanning Pre-colonial Africa, the Colonial Period and Independence Movements.',
                        ...
                        questions: [
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_PRECOLONIAL_AFRICA],
                                difficulty: question_entity_2.QuestionDifficultyType.MEDIUM,
                                estimated_time_in_ms: 60000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            {
                                question_number: 2,
                                description: 'The conference at which European powers formally divided Africa among themselves was held in ___.',
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_COLONIAL_PERIOD],
                                difficulty: question_entity_2.QuestionDifficultyType.MEDIUM,
                                estimated_time_in_ms: 60000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_INDEPENDENCE_MOVEMENTS],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 30000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            {
                                question_number: 5,
                                description: "Who led the movement for Ghana's independence and became its first Prime Minister?",
                    ...
                    {
                        suiteTitle: 'WASSCE History — Ghana Political History & Pre-colonial Trade',
                        suiteDescription: "5 questions covering Ghana's Political History, Culture and Pre-colonial African Empires.",
                        ...
                        questions: [
                            ...
                            },
                            {
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_CULTURE_AND_VALUES],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 45000,
                                class_level: question_entity_2.QuestionClassLevel.SHS_3,
                                exam_year: 2023,
                            ...
                            {
                                question_number: 4,
                                description: 'Under colonialism, the practice of compelling Africans to work without pay for colonial governments or settlers was called ___.',
                                hints: [
                            ...
                            {
                                question_number: 5,
                                description: 'The largest pre-colonial empire in West Africa, known for its gold and salt trade, was the ___.',
                                hints: [
            ...
            const new_wassce_course_version_questions = await Promise.all(new_wassce_course_versions.map(async (version) => {
                const courseTitle = version.course.title;
                const suites = courseQuestionsMap[courseTitle];
                const subjectImageUrl = subjectImageUrls[courseTitle] || subjectImageUrls['Mathematics'];
                const allQuestions = [];
                for (const suiteData of suites) {
                    ...
                    new_suite.suite_type = suiteData.suiteType ?? test_suite_entity_1.SuiteType.YEAR;
                    new_suite.image_url = subjectImageUrl;
                    new_suite.course_version = version;
                    await this.testSuiteRepository.save(new_suite);
                    const new_questions = await Promise.all(suiteData.questions.map(async (question) => {
                        const new_question = new question_entity_1.Question();
                        new_question.correct_answer = question.correct_answer;
                        new_question.description = question.description.replace('/v1/images/seed-sample-question.png', subjectImageUrl);
            ...
            await this.questionRepository.save(new_wassce_course_version_questions.flat());
            ...
            const new_bece_courses = await Promise.all(bece_course_names.map(async (course_name, idx) => {
                const bece_course = new course_entity_1.Course();
                bece_course.avatar_url =
                    subjectImageUrls[course_name] || subjectImageUrls['Mathematics'];
                bece_course.currency = course_entity_2.CurrencyType.USD;
                bece_course.description = `BECE ${course_name} course for JHS students`;
                bece_course.domains = [course_entity_2.DomainType.SCIENCE];
                bece_course.level = course_entity_2.LevelType.BEGINNER;
            ...
            const new_bece_course_versions = await Promise.all(new_bece_courses.map(async (course) => {
                const version = new version_entity_1.Version();
                version.status = version_entity_2.VersionStatusType.APPROVED;
                version.version_number = 1;
                version.course = course;
            ...
            const beceCourseQuestionsMap = {
                Mathematics: [
                    {
                        suiteTitle: 'BECE Mathematics — Number & Algebra',
                        suiteDescription: '5 questions covering Number Operations and Basic Algebra.',
                        ...
                        questions: [
                            {
                                ...
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 45000,
                                class_level: question_entity_2.QuestionClassLevel.JHS_3,
                                exam_year: 2023,
                                correct_answer: '1¼',
                            },
                            {
                    ...
                    },
                    {
                        ...
                        suiteDescription: '5 questions covering Geometry, Measurement, and Basic Statistics.',
                ...
                'English Language': [
                    {
                        ...
                        suiteDescription: '5 questions covering Grammar, Vocabulary, and Word Usage.',
                    ...
                    },
                    {
                        ...
                        suiteDescription: '5 questions covering Reading Comprehension, Figures of Speech, and Writing Skills.',
                ...
                'Social Studies': [
                    {
                        ...
                        suiteDescription: '5 questions covering Ghana\'s history, culture, and national identity.',
                        ...
                        questions: [
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_GHANA_HISTORY],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 30000,
                                class_level: question_entity_2.QuestionClassLevel.JHS_3,
                                exam_year: 2023,
                    ...
                    },
                    {
                        ...
                        suiteDescription: '5 questions covering the arms of government, citizenship rights, and environmental issues.',
                        ...
                        questions: [
                            ...
                            },
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_ENVIRONMENT_AND_SOCIETY],
                                difficulty: question_entity_2.QuestionDifficultyType.MEDIUM,
                                estimated_time_in_ms: 45000,
                                class_level: question_entity_2.QuestionClassLevel.JHS_3,
                                exam_year: 2023,
                ...
                'Integrated Science': [
                    {
                        ...
                        suiteDescription: '5 questions covering Life Processes, Human Health, and Basic Biology.',
                        ...
                        questions: [
                            {
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_LIFE_PROCESSES],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 30000,
                                class_level: question_entity_2.QuestionClassLevel.JHS_3,
                                exam_year: 2023,
                    ...
                    },
                    {
                        ...
                        suiteDescription: '5 questions covering Forces, Sound, the Solar System, and Matter.',
                        ...
                        questions: [
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_PHYSICAL_PROCESSES],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 30000,
                                class_level: question_entity_2.QuestionClassLevel.JHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_EARTH_AND_SPACE],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 30000,
                                class_level: question_entity_2.QuestionClassLevel.JHS_3,
                                exam_year: 2023,
                ...
                'Religious and Moral Education': [
                    {
                        ...
                        suiteDescription: '5 questions covering the core beliefs and practices of Christianity and Islam.',
                        ...
                        questions: [
                            {
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_CHRISTIANITY],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 30000,
                                class_level: question_entity_2.QuestionClassLevel.JHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                options: ['3', '4', '5', '6'],
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_ISLAM],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 30000,
                                class_level: question_entity_2.QuestionClassLevel.JHS_3,
                                exam_year: 2023,
                    ...
                    },
                    {
                        ...
                        suiteDescription: '5 questions covering African Traditional Religion beliefs and core moral values.',
                        ...
                        questions: [
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_AFRICAN_TRADITIONAL_RELIGION],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 45000,
                                class_level: question_entity_2.QuestionClassLevel.JHS_3,
                                exam_year: 2023,
                ...
                ICT: [
                    {
                        ...
                        suiteDescription: '5 questions covering Computer Hardware components and Software types.',
                        ...
                        questions: [
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_COMPUTER_HARDWARE],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 30000,
                                class_level: question_entity_2.QuestionClassLevel.JHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_SOFTWARE_AND_APPLICATIONS],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 45000,
                                class_level: question_entity_2.QuestionClassLevel.JHS_3,
                                exam_year: 2023,
                    ...
                    },
                    {
                        ...
                        suiteDescription: '5 questions covering the Internet, Email, Web Browsers, and Data.',
                        ...
                        questions: [
                            {
                                ...
                                options: [],
                                type: question_entity_2.QuestionType.FILL_IN,
                                tags: [question_entity_2.QuestionTagType.TAG_INTERNET_AND_NETWORKING],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 30000,
                                class_level: question_entity_2.QuestionClassLevel.JHS_3,
                                exam_year: 2023,
                            ...
                            },
                            {
                                ...
                                type: question_entity_2.QuestionType.MULTIPLE_CHOICE,
                                tags: [question_entity_2.QuestionTagType.TAG_DATA_MANAGEMENT],
                                difficulty: question_entity_2.QuestionDifficultyType.EASY,
                                estimated_time_in_ms: 30000,
                                class_level: question_entity_2.QuestionClassLevel.JHS_3,
                                exam_year: 2023,
            ...
            const new_bece_course_version_questions = await Promise.all(new_bece_course_versions.map(async (version) => {
                const courseTitle = version.course.title;
            ...
            await this.questionRepository.save(new_bece_course_version_questions.flat());
            ...
            const new_categories = Object.entries(categoryCoursesMap).map(([category_name, courses]) => {
        ...
        const plans = [
            {
                ...
                price: 0,
                currency: 'GHS',
                interval: subscription_plan_entity_1.PlanInterval.MONTHLY,
                duration_days: 30,
                is_custom: false,
                billing_label: null,
                max_students: null,
            ...
            },
            {
                ...
                price: 243,
                currency: 'GHS',
                interval: subscription_plan_entity_1.PlanInterval.QUARTERLY,
                duration_days: 90,
                is_custom: false,
            ...
            },
            {
                ...
                price: 900,
                currency: 'GHS',
                interval: subscription_plan_entity_1.PlanInterval.YEARLY,
                duration_days: 365,
                is_custom: false,
...
exports.SetupDbService = SetupDbService = SetupDbService_1 = __decorate([
    ...
    __param(0, (0, typeorm_2.InjectRepository)(instructor_entity_1.Instructor)),
    __param(1, (0, typeorm_2.InjectRepository)(organization_entity_1.Organization)),
    __param(2, (0, typeorm_2.InjectRepository)(admin_entity_1.Admin)),
    __param(3, (0, typeorm_2.InjectRepository)(cart_entity_1.Cart)),
    __param(4, (0, typeorm_2.InjectRepository)(course_entity_1.Course)),
    __param(5, (0, typeorm_2.InjectRepository)(version_entity_1.Version)),
    __param(6, (0, typeorm_2.InjectRepository)(question_entity_1.Question)),
    __param(7, (0, typeorm_2.InjectRepository)(category_entity_1.Category)),
    __param(8, (0, typeorm_2.InjectRepository)(test_suite_entity_1.TestSuite)),
    __param(9, (0, typeorm_2.InjectRepository)(image_entity_1.Image)),
    __param(10, (0, typeorm_2.InjectRepository)(subscription_plan_entity_1.SubscriptionPlan)),
...
//# sourceMappingURL=setup-db.service.js.map